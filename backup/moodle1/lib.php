 ...
 */
class moodle1_mod_connectslide_handler extends moodle1_mod_handler {
    ...
    public function get_paths() {
        return array(
            ...
            new convert_path('connect_grades', '/MOODLE_BACKUP/COURSE/MODULES/MOD/CONNECT/GRADING'),
            new convert_path('connect_grade', '/MOODLE_BACKUP/COURSE/MODULES/MOD/CONNECT/GRADING/GRADE'),
        );
    }
    ...
    /**
     * This is executed every time we have one /MOODLE_BACKUP/COURSE/MODULES/MOD/CONNECTSLIDE/GRADES/GRADE
     * data available
     */
